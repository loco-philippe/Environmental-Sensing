...
#%% student
annew2020 = Ilist.Iedic({'notes'     : [14, 12, 13, 15, 17]}, 
                        {'course'    : ['english', 'english', 'math', 'math', 'math'],
                         'examen'    : ['t3', 't4', 't1', 't2', 't3']})        
annew2021 = Ilist.Iedic({'notes'     : [10, 12, 11, 13, 15]}, 
                        {'course'    : ['english', 'english', 'math', 'math', 'math'],
                         'examen'    : ['t2', 't3', 't1', 't2', 't4']})        
camir2020 = Ilist.Iedic({'notes'     : [19, 20, 6, 4]}, 
                        {'course'    : ['software', 'software', 'spanish', 'spanish'],
                         'examen'    : ['t2', 't3', 't1', 't4']})        
camir2021 = Ilist.Iedic({'notes'     : [17, 18, 2, 4]}, 
                        {'course'    : ['software', 'software', 'spanish', 'spanish'],
                         'examen'    : ['t3', 't4', 't1', 't2']})        
judig2020 = Ilist.Iedic({'notes'     : [7, 12, 14, 12]}, 
                        {'course'    : ['software', 'software', 'software', 'spanish'],
                         'examen'    : ['t1', 't2', 't3', 't4']})        
judig2021 = Ilist.Iedic({'notes'     : [5, 10, 12, 10]}, 
                        {'course'    : ['software', 'software', 'software', 'spanish'],
                         'examen'    : ['t1', 't3', 't4', 't2']})        
philb2020 = Ilist.Iedic({'notes'     : [8, 20]}, 
                        {'course'    : ['english', 'math'],
                         'examen'    : ['t3', 't2']})        
philb2021 = Ilist.Iedic({'notes'     : [18, 6]}, 
                        {'course'    : ['software', 'english'],
                         'examen'    : ['t3', 't4']})        
philw2020 = Ilist.Iedic({'notes'     : [10, 17]}, 
                        {'course'    : ['history', 'math'],
                         'examen'    : ['t2', 't1']})        
philw2021 = Ilist.Iedic({'notes'     : [8, 15]}, 
                        {'course'    : ['history', 'math'],
                         'examen'    : ['t2', 't1']})        
#%% group
group2020 = Ilist.Iedic(
    {'notes'     : [annew2020, camir2020, judig2020, philb2020, philw2020]},
    {'full name' : ['anne white', 'camille red', 'judith grey', 'philippe black', 'philippe white'],
...
#%% global
abq = Ilist.Iedic({'notes'   : [group2020, group2021]},
                    {'year'    : [2020, 2021],
                     'school'  : ['albuquerque', 'albuquerque']})
abqm= abq.merge() # len : 34
print('taille json (raw / merged) : ', len(abq.json(encoded=True)), 
      len(abqm.json(encoded=True)) ) # 2618 1637
print('taille cbor (raw / merged) : ', len(abq.json(encoded=True, encode_format='cbor')),
      len(abqm.json(encoded=True, encode_format='cbor')) ) # 1597 760
...
print('axes coupling (1: coupled, 0 : not) - descending : ', il.axescoupling(il.axesmin))
il.mergeidx([0,3,4])
