    ...
    *export methods (`observation.iindex_interface.IindexInterface`)*
    ...
    def Iobj(cls, bs, extkeys=None, typevalue=ES.def_clsName, context=True, reindex=False):
        ...
        *Returns* : tuple(code, Iindex) '''
        return cls.from_obj(bs, extkeys=extkeys, typevalue=typevalue, context=context, reindex=reindex)[1]
    ...
    def from_obj(cls, bs, extkeys=None, typevalue=ES.def_clsName, context=True, reindex=False):
        ...
        *Returns* : tuple(code, Iindex) '''
        ...
        return (parent, cls(codec=codec, name=name, keys=keys, typevalue=typevalue, reindex=reindex))
