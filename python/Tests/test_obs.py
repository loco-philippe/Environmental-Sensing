...
from observation import Observation, NamedValue, DatationValue, LocationValue,\
    PropertyValue, ExternValue, ESValue, Dataset, Field, ES, util, TimeSlot
...
class TestExamples(unittest.TestCase):
    ...
    def test_observation_for_sensor(self):
        ...
        il_sensor = Dataset.obj([['res', [], -1], ['datation', []],
                               ['property', []]])
        property = [prop1, prop2]
        for i in range(6):  # simule une boucle de mesure
            date = datetime.datetime(2021, 6, 4+i, 12, 5)
...
class TestObservation(unittest.TestCase):
    ...
    def test_obs_creation_copy(self):
        listob = [Observation(), Observation(listidx=Dataset.obj([1, 2, 3])),
                  ...
                  Observation(
                      Dataset.obj([list(dat1), list(loc1), list(prop3), list(_res(3))]), name='truc'),
    ...
    def test_obs_loc_iloc_maj(self):
        ob = Observation(Dataset.obj([list(dat3), list(loc3)+[0], list(prop2),
