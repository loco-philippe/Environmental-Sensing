...
class Test_iindex(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(Iindex(idx) == Iindex.Iext(idx)
                        == Iindex.Idic(idx) == idx)
    ...
    def test_obj(self):
        ...
        for val in listval:
            ...
            self.assertTrue(Iindex.Iobj(Iindex.Iobj(
                val).to_obj()) == Iindex.Iobj(val))
        val = ['namvalue', ['value']]
    ...
    def test_derkeys(self):
        ...
        grandpere = Iindex.Iext(
            [0,     0,   2,   3,   4,   4,   6,   7,   8,   9,   9,  11,  12])
        pere = Iindex.Iext(['j', 'j', 'f', 'a', 'm', 'm',
                           's', 's', 's', 'n', 'd', 'd', 'd'])
        fils = Iindex.Iext(['t1', 't1', 't1', 't2', 't2',
                           't2', 't3', 't3', 't3', 't4', 't4', 't4', 't4'])
        petitfils = Iindex.Iext(
    ...
    def test_json(self):
        ...
        self.assertTrue(Iindex.Iobj(Iindex().to_obj()).to_obj()
                        == Iindex().to_obj() == [])
        parent = Iindex.Iext(['j', 'j', 'f', 'f', 'm', 's', 's'])
        fils = Iindex.Iext(['t1', 't1', 't1', 't1', 't2', 't3', 't3'])
