...
class Test_Field(unittest.TestCase):
    ...
    def test_periodic_coef(self):
        ...
        self.assertEqual(Field.encodecoef([0,0,1,1,2,2,4,4]), 0)
        self.assertEqual(Field.encodecoef([0,1,2,3,4,5,6,7]), 1)
        self.assertEqual(Field.encodecoef([0,0,0,0,1,1,1,1]), 4)
        self.assertEqual(Field.encodecoef([1,1,1,1,0,0,0,0]), 0)
