...
class Test_Ilist3(unittest.TestCase):
    ...
    def test_creation_simple(self) :
        ...
        self.assertTrue(iidx.lidx[2].values  == iidx3.lidx[2].values == 
                        ...
                        iidx1.lidx[2].values)
        self.assertTrue(Ilist3().to_obj() == [])
        self.assertEqual(Ilist3(Ilist3([[0, 2, 0, 2, 0], [10,0,20,20,15]])), 
                         Ilist3([[0, 2, 0, 2, 0], [10,0,20,20,15]]))
        
    def test_creation_variable(self) :
        #self.assertEqual(Ilist2(indexset=['i1', [1, 2, 3]]), Ilist2([defv, [True, True, True]], ['i1', [1, 2, 3]]))
        il = Ilist3([['namvalue'     , ['a', 'b', 'c', 'd', 'e', 'f']],
                     ['datationvalue', [10,20,30]],
                     ['locationvalue', [100,200,300], 1],
                     ['propertyvalue', [True, False]]], var=0)
        il1= Ilist3([['namvalue'     , ['a', 'b', 'c', 'd', 'e', 'f'], -1],
                     ['datationvalue', [10,20,30]],
                     ['locationvalue', [100,200,300], 1],
                     ['propertyvalue', [True, False]]])
        il2 =Ilist3([['namvalue'     , ["a", "b", "c", "d", "e", "f"], -1], 
                     ['datationvalue', [10, 10, 20, 20, 30, 30]],
                     ['locationvalue', [100, 100, 200, 200, 300, 300]],
                     ['propertyvalue', [True, False, True, False, True, False]]])   
        self.assertTrue(il == il1 == il2)
        self.assertTrue(il == Ilist3(il.lindex, var=il.lvarrow) == copy(il))  
        
    def test_creation_idic_iext(self) :
        iidx = Ilist3.Idic({'datationvalue': [10, 10, 20, 20, 30, 30],
                            'locationvalue': [100, 100, 200, 200, 300, 300],
                            'propertyvalue': [True, False, True, False, True, False]})   
        iidx1 =Ilist3.Iext([[10, 10, 20, 20, 30, 30], [100, 100, 200, 200, 300, 300],
        ...
        self.assertTrue(Ilist3.Idic({}) == Ilist3.Idic() == Ilist3() ==
                        Ilist3.Iext([]) == Ilist3.Iext())
    ...
    def test_creation_idic_iext_variable(self) :
        iidx = Ilist3.Idic({'varvalue'     : ['a', 'b', 'c', 'd', 'e', 'f'],
                            'datationvalue': [10, 10, 20, 20, 30, 30],
                            'locationvalue': [100, 100, 200, 200, 300, 300],
                            'propertyvalue': [True, False, True, False, True, False]},
                           var=0)   
        iidx1 =Ilist3.Iext([['a', 'b', 'c', 'd', 'e', 'f'],
                            [10, 10, 20, 20, 30, 30], 
                            [100, 100, 200, 200, 300, 300],
                            [True, False, True, False, True, False]],
                           ['varvalue', 'datationvalue', 'locationvalue', 'propertyvalue'],
                           var=0)
        iidx2 =Ilist3.Iext([[10, 10, 20, 20, 30, 30], 
                            [100, 100, 200, 200, 300, 300],
                            [True, False, True, False, True, False],
                            ['a', 'b', 'c', 'd', 'e', 'f']],
                           ['datationvalue', 'locationvalue', 'propertyvalue', 'varvalue'],
                           var=3)
        iidx4 = Ilist3(    [['varvalue', ['a', 'b', 'c', 'd', 'e', 'f'], -1],
                            ['datationvalue', [10, 10, 20, 20, 30, 30]],
                            ['locationvalue', [100, 100, 200, 200, 300, 300]],
                            ['propertyvalue', [True, False, True, False, True, False]]])   
    ...
    def test_properties(self) :
        il=Ilist3([['ext', ['er', 'rt', 'er', 'ry'], -1],[0, 2, 0, 2], 
        ...
        il = Ilist3([['ext', ['er', 'rt', 'er', 'ry'], -1], [0, 2, 0, 0], [30, 12, 20, 20]])
        #il.reindex()
        self.assertFalse( il.consistent)
        il = Ilist3([['ext', ['er', 'rt', 'er', 'ry'], -1], [0, 2, 0, 1], [30, 12, 20, 20]])
        #il.reindex()
    ...
    def test_add_update_list(self) :
        ...
        il= Ilist3([['a', 'b', 'c'], [1, 2, 2], [4, 5, 5]])
        il.updateindex(["d", 8, 2], 1)
        il.append(["z", 1, 10])
        self.assertEqual(il.idxlen, [4, 4, 3])

    def test_add(self):
        il1 = Ilist3([[['er', 'rt', 'er', 'ry', 'ab'], -1], [0, 2, 0, 2, 0], [10,0,20,20,15]])
        il2 = Ilist3([[['_er', '_rt', '_er', '_ry', '_ab'], -1], [10, 12, 10, 12, 10], 
                      [110,10,120,120,115]])
        il3 = il1 + il2
        ...
        il2 = Ilist3([[['_er', '_rt', '_er', '_ry', '_ab'], -1], [10, 2, 10, 12, 10], 
                      [110,0,120,120,115]])
        il3 = il1 + il2
        self.assertEqual(len(il3) , len(il1) + len(il2))
    ...
    def test_swap(self):
        il = Ilist3([[10,20,30],[[100,200,300], 0], [True, False]])
        il1 = copy(il)
        il.swapindex([2,0,1])
        il.swapindex([2,0,1])
        il.swapindex([2,0,1])
    ...
    def test_extend(self):
        il1 = Ilist3([['er', 'rt', 'er', 'ry', 'ab'], [0, 2, 0, 2, 0], [10,0,20,20,15]])
        il2 = Ilist3([[['_er', '_rt', '_er', '_ry', '_ab'], -1], [10, 12, 10, 12, 10], 
                      [110,10,120,120,115]])
        il3 = il1 | il2
        self.assertEqual(il3.lenidx, il1.lenidx + il2.lenidx)
        il  = Ilist3(['er', 'rt', 'er', 'ry', 'ab', 'ert'])
        ilx = Ilist3([[0,0,0,1,1,1], [0,1,2,3,4,1]])
        il2 = il | ilx
    ...
    def test_append(self) :
        il=Ilist3([[0, 2, 0, 2], [30, 12, 20, 15]])
        il.append([0,20], unique = True)
        self.assertEqual( len(il), 4)
        il.append([0,40])
        self.assertEqual( len(il), 5)
        self.assertEqual( il, Ilist3([[0, 2, 0, 2, 0], [30, 12, 20, 15, 40]]))

    def test_append_variable(self) :
        il=Ilist3([[['er', 'rt', 'er', 'ry'], -1], [0, 2, 0, 2], [30, 12, 20, 15]])
        il.append(['truc', 0, 20], unique = True)
        self.assertEqual( len(il), 4)
        il.append(['truc', 0, 40])
        self.assertEqual( len(il), 5)
        self.assertEqual( il, Ilist3([['er', 'rt', 'er', 'ry', 'truc'], 
                                      [0, 2, 0, 2, 0], [30, 12, 20, 15, 40]], var=0))


    def test_magic(self):
        iidx5 = Ilist3([['datationvalue', [10, 10, 20, 20, 30, 30]],
                           ['locationvalue', [100, 100, 200, 200, 300, 300]],
                           ['propertyvalue', [True, False, True, False, True, False]]])   
    ...
    def test_primary(self):
        ['ext', ['er', 'rt', 'er', 'ry']]
        ilm = Ilist3.Iext([['math', 'english', 'software', 'physic', 'english', 'software'],
        ...
        ilm = Ilist3([['ext', ['er', 'rt', 'er', 'ry'], -1], [0, 2, 0, 2], [30, 12, 12, 15],
                      [2, 0, 2, 0], [2, 2, 0, 0], ['info', 'info', 'info', 'info'],[12, 12, 15, 30]])
        self.assertEqual(ilm.primary, [0, 1, 5])        
        ilm = Ilist3([['ext', ['er', 'rt', 'er', 'ry'], -1], [0, 2, 0, 2], [30, 12, 20, 30],
                      [2, 0, 2, 0], [2, 2, 0, 0], ['info', 'info', 'info', 'info'],[12, 20, 20, 12]])
        self.assertEqual(ilm.primary, [0, 1, 3])        
        ilm = Ilist3.Iext([[0, 2, 0, 2], [30, 12, 12, 15], [2, 0, 2, 0], [2, 2, 0, 0], 
                              ['info', 'info', 'info', 'info'],[12, 12, 15, 30]])
        self.assertEqual(ilm.primary, [0, 1, 5])        
        ilm = Ilist3.Iext([[0, 2, 0, 2], [30, 12, 20, 30], [2, 0, 2, 0], [2, 2, 0, 0], 
                              ['info', 'info', 'info', 'info'],[12, 20, 20, 12]])
        self.assertEqual(ilm.primary, [0, 1, 3])
        
    def test_to_obj(self):
        ilm = Ilist3.Iext([[0,     0,   2,   3,   4,   4,   6,   7,   8,   9,   9,  11,  12 ],
        ...
        for ts in test:
            ...
            self.assertEqual(Ilist3.from_obj(ilm.to_obj()), ilm)
            #self.assertEqual(Ilist3.from_obj(ilm.to_obj()).to_obj(), ilm.to_obj())
        encoded     = [True, False]
        format      = ['json', 'cbor']
        ...
        for ts in test:
            ...
            self.assertEqual(Ilist3.from_obj(ilm.to_obj(**opt)), ilm)
        ilm = Ilist3.Iext([[6, 7, 8, 9, 9, 11, 12],
                              ['s', 's', 's', 'n', 'd', 'd', 'd' ]])
        ilm.coupling()
        for ts in test:
            opt = {'encoded': ts[0], 'encode_format': ts[1], 'fullcodec': ts[2],
    ...
    def test_to_obj_variable(self):
        il = Ilist3.Iext([[0,1,2,3,4,5], 
                          ...
                          [100,100,200,200,300,300], 
                          [True, False, True, False, True, False]], var=0)
        self.assertEqual(Ilist3.from_obj(il.to_obj()), il)
        il.to_keyscrossed()
        self.assertEqual(Ilist3.from_obj(il.to_obj()), il)
        self.assertEqual(Ilist3.from_obj(), Ilist3())
        
    def test_coupling(self):
        ilx = Ilist3.Iext([['a', 'b', 'b', 'c', 'c', 'a'], 
        ...
        il=Ilist3([[[1,2,3,4,5,6], -1], ['a', 'b', 'b', 'c', 'c', 'a'], 
         [20,  10,  10,  10,  10,  20], [200, 200, 300, 200, 300, 300]] )
    ...
    def test_merge(self):
        ...
        il3 = Ilist3([il1, il2], typevalue=None)
        self.assertEqual(il3.merge(merge=True, update=True).loc(["english", "gr1"]), 14)

    def test_csv(self):
        il=Ilist3([[['er', 'rt', 'er', 'ry'], -1], [0, 2, 0, 2], [30, 12, 20, 15]])
        il.to_csv()
        il2 = Ilist3.from_csv(var=0)
        self.assertTrue(il == il2)
        if ES.def_clsName: 
            il.to_csv(ifunc=ESValue.vSimple)
            il.to_csv(ifunc=ESValue.json, encoded=False)
            il3 = Ilist3.from_csv(var=0)
            self.assertTrue(il == il3)
        il=Ilist3.Iext([['er', 'rt', 'er', 'ry', 'ab'], [0, 2, 0, 2, 0], [10,0,20,20,15], [1,2,1,2,1]], var=0)
        il.to_csv(optcsv={'dialect':'excel', 'delimiter':';'})
        il2 = Ilist3.from_csv(var=0, optcsv={'dialect':'excel', 'delimiter':';'})
        self.assertTrue(il == il2)
    ...
    def test_sort(self) :
        il=Ilist3.Iext([['er', 'rt', 'er', 'ry'], [0, 2, 0, 2], [30, 12, 20, 15]], var=0)
        il.sortkeys()
    ...
    def test_filter(self):
        il=Ilist3.Iext([['er', 'rt', 'er', 'ry'], [0, 2, 0, 2], [30, 12, 20, 15]])
    ...
    def test_full(self) :
        il=Ilist3.Iext([['er', 'rt', 'er', 'ry'], [0, 2, 0, 2], [30, 12, 20, 30], 
    ...
    def test_to_obj_file(self): #!!!
        il = Ilist3([['result', [0,1,2,3,4,5], -1],
        ...
        for ts in test:
            ...
            #il2 = Ilist3.from_obj(il.to_obj(**option))
